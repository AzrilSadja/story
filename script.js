document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Story of The Joyfull Journey" },
        ...
        { time: 44, text: "Aku harap selamanya akan seperti ini" },
        { time: 48, text: "Bersama kita bisa menghadapi semuanya" },
        { time: 52, text: "Tetaplah kita pegang erat hubungan ini, janganlah sampai berakhir ya sayang"}
    ];
